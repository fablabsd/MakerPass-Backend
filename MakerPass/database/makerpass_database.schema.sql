...
BEGIN TRANSACTION;
CREATE TABLE machine_rec(machine_id varchar(32), description varchar(127), parent_machine_id varchar(32), plug_id varchar(32));
...
CREATE TABLE user_rec(user_id varchar(32), username varchar(32), firstname varchar(32), lastname varchar(32), last_scan text, total_time_allocated integer, total_time_logged integer);
